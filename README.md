...
A curated collection of 7 professional-grade Claude Code plugins for enhancing AI-assisted workflows.
...
/plugin install multi-perspective@claude-tools
/plugin install gemini-api@claude-tools
/plugin install agent-browser@claude-tools
...
claude-tools/
├── .claude-plugin/
│   └── marketplace.json          # Marketplace metadata (v1.6.0)
├── LICENSE                       # MIT License
